package com.wykmmam.rest_spring_java.unittests.mapper;
...
import com.wykmmam.rest_spring_java.unittests.mapper.mocks.MockPerson;
...
public class ObjectMapperTests {
    ...
    public void parseEntityToDTOTest() {
        PersonDTO output =
                parseObject(inputObject.mockEntity(), PersonDTO.class);
    ...
    public void parseEntityListToDTOListTest() {
        List<PersonDTO> outputList =
                parseListObjects(inputObject.mockEntityList(), PersonDTO.class);
    ...
    public void parserDTOListToEntityListTest() {
        List<Person> outputList =
                parseListObjects(inputObject.mockDTOList(), Person.class);
